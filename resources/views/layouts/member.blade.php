...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/member/dashboard">
            ...
            <!-- Nav Item - Profile -->
            <li class="nav-item">
                <a class="nav-link" href="/member/edit">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Layanan Bidan Nani Herawati {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
